    ...
    <div class="container">
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-menu">
                ...
                <a href="/customer-management" class="nav-item active">
        ...
        <main class="main-content">
            ...
            <div class="table-card">
                <div class="card-title">
                    <h3><i class="ri-table-line"></i> Danh sách khách hàng</h3>
                </div>
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>kh002</td>
                            <td>0944567890</td>
                            <td><span class="status cancelled"><i class="ri-close-circle-line"></i> Đã hủy</span></td>
                            <td>
                                <button class="btn btn-sm btn-outline"><i class="ri-edit-line"></i> Sửa</button>
                                <button class="btn btn-sm btn-outline"><i class="ri-delete-bin-line"></i> Xóa</button>
                            </td>
